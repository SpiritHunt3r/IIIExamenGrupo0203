 ...
 * @author ayma-93
 */
public class HandlerImagen implements Handler {
    
    private Handler siguiente;
    private String nombre;

    public HandlerImagen(String nombre) {
        this.nombre = nombre;
    }
    ...
    public void procesar(Archivo archivo) {
        ...
        if (archivo.getTipo().equals("Imagen")) {
            ...
            System.out.println("Procesando y guardando la información de la imagen "+ archivo.getNombre() +" ... Encargado : "+nombre);
