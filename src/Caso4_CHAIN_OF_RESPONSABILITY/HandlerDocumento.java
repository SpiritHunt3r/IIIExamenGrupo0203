 ...
 * @author ayma-93
 */
public class HandlerDocumento implements Handler{
    
    private Handler siguiente;
    private String nombre;

    public HandlerDocumento(String nombre) {
        this.nombre = nombre;
    }
    ...
    public void procesar(Archivo archivo) {
        ...
        if (archivo.getTipo().equals("Documento")) {
            
            System.out.println("Procesando y guardando la información del documento "+ archivo.getNombre() +" ... Encargado : "+nombre);
