 ...
 * @author ayma-93
 */
public class HandlerVideo implements Handler {
    
    private Handler siguiente;
    private String nombre;

    public HandlerVideo(String nombre) {
        this.nombre = nombre;
    }
    ...
    public void procesar(Archivo archivo) {
        ...
        if (archivo.getTipo().equals("Video")) {
            ...
            System.out.println("Procesando y guardando la información del video "+ archivo.getNombre() +" ... Encargado : "+nombre);
