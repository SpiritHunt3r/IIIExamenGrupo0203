 ...
 * @author ayma-93
 */
public class HandlerAudio implements Handler {
    
    private Handler siguiente;
    private String nombre;

    public HandlerAudio(String nombre) {
        this.nombre = nombre;
    }
    ...
    public void procesar(Archivo archivo) {
        ...
        if (archivo.getTipo().equals("Audio")) {
            
            System.out.println("Procesando y guardando la información del audio "+ archivo.getNombre() +" ... Encargado : "+nombre);
